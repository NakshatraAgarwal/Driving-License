...
def show_license():
    label_id["text"] = 1570375937
    label_name["text"] = "Nakshatra"
    label_dob["text"]  = "31 October 2009"
    label_pin["text"] = 382675
    label_address["text"] = "Mumbai, Maharashtra"
    label_vehicle_type["text"] = ["two", "four"]
    
    
# Create a button
button1 = Button(root, text="Show my License", command = show_license)
